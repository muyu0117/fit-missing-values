...
'''This script builds a proxy for the time series of the SP500 index log-values,
via a linear combination of log-values of individual stocks included in the index
'''

## For details, see [here](/lab/redirect.php?permalink=EB_ProxyStocks).
...
from matplotlib.pyplot import figure, plot, legend, xlim, ylim, ylabel,     xticks
